...
var PinInputContainer = styled__default["default"].div(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n"], ["\n  display: flex;\n  align-items: center;\n"])));
...
var propTypes$2 = {
    ...
    values: PropTypes__default["default"].arrayOf(PropTypes__default["default"].string),
...
var PinInputField = function (_a) {
    ...
    var pattern = React.useMemo(function () { return validateToPattern(validate); }, [validate]);
    // auto-focus on mount
...
var PinInput = function (props) {
    var completed = React.useMemo(function () { return props.values.every(function (val) { return val; }); }, [props.values]);
    ...
    return (React__default["default"].createElement(PinInputContainer, { className: props.containerClassName, style: props.containerStyle }, props.values.map(function (value, i) { return (React__default["default"].createElement(PinInputField, __assign({ key: props.id ? "".concat(props.id, "-").concat(i) : i, index: i, value: value, completed: completed }, props))); })));
};
...
var StatefulPinInput = function (_a) {
    ...
    var _b = React.useState(Array.from({ length: length }, function (_v, i) { return initialValue[i] || ''; })), values = _b[0], setValues = _b[1];
    ...
    return React__default["default"].createElement(PinInput, __assign({ values: values, onChange: handleInputChange }, props));
};
...
exports.StatefulPinInput = StatefulPinInput;
